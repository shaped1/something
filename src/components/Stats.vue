  ...
  methods: {
    async fetch() {
      ...
      const [downloads, stars, contributors] = await Promise.all([
        fetch('https://api.npmjs.org/downloads/range/2013-08-21:2100-08-21/@androz2091/insta.js').then(json, noop),
        fetch('https://api.github.com/repos/androz2091/insta.js').then(json, noop),
        fetch('https://api.github.com/repos/androz2091/insta.js/stats/contributors').then(json, noop),
      ]);
